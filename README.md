...
The tar file can be downloaded, extracted and 'python3 pi01' run to start the web service.  Initial controls (in version 0.0.1 only) are protected with username 'astro', password 'station'. The tar file can be imported into the full skipole framework for further development.